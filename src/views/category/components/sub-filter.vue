<template>
    ...
    <div class="sub-filter" v-if="filterData && !loading">
        ...
        <div class="item">
            ...
            <div class="body">
                <a @click="changeBrand(brand.id)" :class="{active:filterData.selectedBrand === brand.id}" href="javascript:;"
        ...
        <div class="item" v-for="attr in filterData.saleProperties" :key="attr.id">
            ...
            <div class="body">
                <a @click="changeProp(attr,prop.id)" :class="{active:attr.selectedProp === prop.id}" href="javascript:;"
                   v-for="prop in attr.properties" :key="prop.id">{{ prop.name
                                                                  }}</a>
            </div>
        </div>
    </div>
